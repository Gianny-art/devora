      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        {mode !== 'forgot' && (
          <div className="space-y-2.5">
            <Button variant="outline" className="w-full gap-2 h-10" onClick={() => handleOAuth('google')} disabled={!!oauthLoading}>
              {oauthLoading === 'google' ? (
            ...
            <Button variant="outline" className="w-full gap-2 h-10" onClick={() => handleOAuth('apple')} disabled={!!oauthLoading}>
              {oauthLoading === 'apple' ? (
                <span className="w-4 h-4 border-2 border-primary border-t-transparent rounded-full animate-spin" />
              ) : (
            ...
            <div className="relative">
              <Separator />
              <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-background px-3 text-xs text-muted-foreground">{t('auth.or')}</span>
            </div>
          </div>
        )}
